...
var member = {
	...
	email : {
		valid : {
			code : 'valid', desc : '사용가능한 이메일입니다'
		},
		invalid : {
			code : 'invalid', desc : '사용할 수 없는 이메일입니다'
		},
	...
	id: {
		unUsable : {
			code : 'invalid', desc : '이미사용중인 아이디'
		},
		usable : {
			code : 'valid', desc : '사용가능한 아이디'
		},
		valid : {
			code : 'valid', desc : '아이디 중복확인을 하세요'
		},
		invalid : {
			code : 'invalid', desc : '영문 소문자, 숫자를 입력하세요'
		},
    ...
    pw: {
		lack : {
			code : 'invalid', desc : '영문 대/소문자, 숫자를 모두 포함'
		},
        invalid : {
            code : 'invalid', desc : '영문대/소문자,숫자만 입력하세요'
        },
        valid : {
            code : 'valid', desc : '사용가능한 비밀번호 입니다'
        },
        equal : {
            code : 'valid', desc : '비밀번호가 일치합니다'
        },
        notEqual : {
            code : 'invalid', desc : '비밀번호가 일치하지않습니다'
        },
    },
    //공통사용할 상태값
    common: {
        empty : {
            code:'invalid', desc: '입력하세요'
        },
        space: {
            code:'invalid', desc: '공백없이 입력하세요'
        },
        max : {
            code:'invalid', desc: '최대 10자 이하로 입력하세요'
        },
        min : {
            code:'invalid', desc: '최소 5자 이상 입력하세요'
        },
    }
}